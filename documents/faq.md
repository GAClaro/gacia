...
## O plano Starter possui acesso à API?

Não. O acesso à API está disponível apenas nos planos Professional e Enterprise.
...
Clientes que realizaram uma contratação anual podem solicitar reembolso em até 7 dias após a contratação, desde que não tenham utilizado recursos classificados como serviços adicionais.
